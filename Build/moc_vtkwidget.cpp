...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_vtkwidget_t, stringdata) + ofs \
...
void vtkwidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->readimseq((*reinterpret_cast< vtkStringArray*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 10: _t->buildhist((*reinterpret_cast< vtkImageData*(*)>(_a[1]))); break;
        case 11: _t->setvram((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (vtkwidget::*_t)(QVector<double> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&vtkwidget::sendhist)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject vtkwidget::staticMetaObject = {
    { &QVTKWidget::staticMetaObject, qt_meta_stringdata_vtkwidget.data,
      qt_meta_data_vtkwidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *vtkwidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkwidget.stringdata))
