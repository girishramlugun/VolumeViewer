...
public:
    ...
    {
        dialog_vol_prop->setWindowTitle(QApplication::translate("dialog_vol_prop", "Volume Dimensions", nullptr));
        set_vol_dim->setText(QApplication::translate("dialog_vol_prop", "Set", nullptr));
        cancel_vol_dim->setText(QApplication::translate("dialog_vol_prop", "Cancel", nullptr));
    } // retranslateUi
