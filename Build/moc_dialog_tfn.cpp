...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_dialog_tfn_t, stringdata0) + ofs \
...
void dialog_tfn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (dialog_tfn::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dialog_tfn::sendtfn)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject dialog_tfn::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_dialog_tfn.data,
      qt_meta_data_dialog_tfn,  qt_static_metacall, nullptr, nullptr}
};
...
void *dialog_tfn::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dialog_tfn.stringdata0))
