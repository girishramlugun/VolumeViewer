...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_dialog_color_t, stringdata) + ofs \
...
void dialog_color::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (dialog_color::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&dialog_color::volcol)) {
                *result = 0;
            }
        }
        {
            typedef void (dialog_color::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&dialog_color::wincol)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject dialog_color::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_dialog_color.data,
      qt_meta_data_dialog_color,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *dialog_color::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dialog_color.stringdata))
        return static_cast<void*>(const_cast< dialog_color*>(this));
