...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Dialog_Bg_t, stringdata0) + ofs \
...
void Dialog_Bg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Dialog_Bg::*)(double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dialog_Bg::sendbgparams)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Dialog_Bg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Dialog_Bg.data,
      qt_meta_data_Dialog_Bg,  qt_static_metacall, nullptr, nullptr}
};
...
void *Dialog_Bg::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Dialog_Bg.stringdata0))
