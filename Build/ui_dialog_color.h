...
public:
    ...
    {
        dialog_color->setWindowTitle(QApplication::translate("dialog_color", "Dialog", 0));
        label->setText(QApplication::translate("dialog_color", "Volume Color", 0));
        label_2->setText(QApplication::translate("dialog_color", "Window Color", 0));
        vc->setText(QString());
        wc->setText(QString());
    } // retranslateUi
