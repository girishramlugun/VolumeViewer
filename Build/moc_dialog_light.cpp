...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_dialog_light_t, stringdata0) + ofs \
...
void dialog_light::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (dialog_light::*)(double , double , double , double , double , double , double , double , double , double , double , double , double , double , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dialog_light::sendlights)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject dialog_light::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_dialog_light.data,
      qt_meta_data_dialog_light,  qt_static_metacall, nullptr, nullptr}
};
...
void *dialog_light::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dialog_light.stringdata0))
...
// SIGNAL 0
void dialog_light::sendlights(double _t1, double _t2, double _t3, double _t4, double _t5, double _t6, double _t7, double _t8, double _t9, double _t10, double _t11, double _t12, double _t13, double _t14, bool _t15)
{
