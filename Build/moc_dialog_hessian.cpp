...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_dialog_hessian_t, stringdata0) + ofs \
...
void dialog_hessian::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (dialog_hessian::*)(double , double , double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dialog_hessian::sendhessparams)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject dialog_hessian::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_dialog_hessian.data,
      qt_meta_data_dialog_hessian,  qt_static_metacall, nullptr, nullptr}
};
...
void *dialog_hessian::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dialog_hessian.stringdata0))
