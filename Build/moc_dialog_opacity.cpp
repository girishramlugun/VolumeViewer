...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_dialog_opacity_t, stringdata) + ofs \
...
void dialog_opacity::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (dialog_opacity::*_t)(int , bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&dialog_opacity::sendopa)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject dialog_opacity::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_dialog_opacity.data,
      qt_meta_data_dialog_opacity,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *dialog_opacity::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dialog_opacity.stringdata))
        return static_cast<void*>(const_cast< dialog_opacity*>(this));
