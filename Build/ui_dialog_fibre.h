...
public:
    ...
    {
        Dialog_Fibre->setWindowTitle(QApplication::translate("Dialog_Fibre", "Select Display Parameters", 0));
        label->setText(QApplication::translate("Dialog_Fibre", "Set Minimum Fibre Length:", 0));
        label_2->setText(QApplication::translate("Dialog_Fibre", "Set Resolution:", 0));
    } // retranslateUi
